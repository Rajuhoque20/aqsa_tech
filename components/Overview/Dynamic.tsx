...
export default function DynamicOverview() {
  ...
  const overviewData = [
    { id: "1", class: "left-in", title: "PROJECT ENROLLED", count: `${count.student}+` },
    { id: "2", class: "bottom-in", title: "WEBSITE DELIVERED", count: `${count.teacher}+` },
    { id: "3", class: "right-in", title: "WEBSITE ONGOING", count: `${count.passing_ratio}` },
  ];

  return (
    <div className="mt-10 px-0  md:px-20 flex justify-between gap-3 items-center relative" ref={ref}>
